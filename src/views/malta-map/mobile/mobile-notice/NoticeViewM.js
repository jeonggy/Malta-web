...
class NoticeViewM extends Component {
  constructor(props) {
    super(props)
    this.state = {
      index: 0,
      ...
      <>
        ...
        <CCol style={{ padding: '40px 20px' }}>
          <CCol className="text-left">
            <p style={{ fontWeight: 400, color: '#a3a3a3', fontSize: '16px' }}>
              업데이트 | 2022.4.25
            </p>
          ...
          <CCol className="text-center">
            <CButton onClick={() => this.noticelistBtnClicked()} className="news-list-btn-m">
              목록
            </CButton>
          </CCol>
        </CCol>
