...
import { CCol, CImage, CCarousel, CCarouselItem, CCarouselCaption } from '@coreui/react'

class MobileServiceSlider1 extends Component {
  constructor(props) {
    super(props)
    this.state = {
      index: 0,
...
export default MobileServiceSlider1
